Rails.application.routes.draw do
  ...
  get   "browse/:ini_career/to/:sub_career",  to: "home#browse_stories_explore",  as: :browse_stories_explore
  get   "browse/:ini_career/to/:sub_career",  to: "home#browse_stories_pursue",   as: :browse_stories_pursue
